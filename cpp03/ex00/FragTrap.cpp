...
{
	std::cout << TITLE << this->name << " attaque " << target << " à distance, causant " << this->ranged_attack_damage
			  << " points de dégâts !" << std::endl;
}

void FragTrap::meleeAttack(const std::string &target)
{
	std::cout << TITLE << this->name << " attaque " << target << " en mélée, causant " << this->melee_attack_damage
			  << " points de dégâts !" << std::endl;
}
...
void FragTrap::takeDamage(unsigned int amount)
{
	...
	else
	{
		...
		std::cout << TITLE << this->name << " a pris " << damages << " points de dégâts !" << std::endl;
	}
}
...
void FragTrap::beRepaired(unsigned int amount)
{
	...
	if (heal)
	{
		std::cout << TITLE << this->name << " a été soigné de " << heal << " points de dégâts !" << std::endl;
	}
	else
	{
		std::cout << TITLE << this->name << " n'a pas été soigné car des points de dégâts sont déjà pleins"
				  << std::endl;
	}
	if (heal_energy)
	{
		std::cout << TITLE << this->name << " a récupéré " << heal_energy << " points d'énergie !" << std::endl;
	}
	else
	{
		std::cout << TITLE << this->name << " n'a pas récupéré de point d'énergie car des points de d'énergie sont déjà pleins"
				  << std::endl;
	}
}
...
void FragTrap::vaulthunter_dot_exe(const std::string &target)
{
	...
	{
		std::cout << TITLE << this->name << " n'a pas assez d'énergie !" << std::endl;
	}
	else
	{
		...
		std::cout << TITLE << this->name << " attaque avec " << attack_names[random_number] << " ! Il inflige "
